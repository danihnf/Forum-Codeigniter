               ...
               <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navigation">
                         <ul class="nav navbar-nav navbar-right">
                              ...
                              <li><a href="<?php echo base_url()?>landing/galeri">Galeri</a></li>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                         <a href="<?php echo base_url()?>landing/galeri" class="btn btn-default btn-rpl">Load More  <img src="<?php echo base_url()?>assets/images/ic-btn-pointer.svg"></a>
                    </div>
               </div>
          </div>
     </section>
     ...
     <section id="demo">
          <div class="container">
               <div class="row">
                    ...
                    <div class="box-btn">
                         <a href="<?php echo base_url(); ?>home/mforum2/1" class="btn btn-block">Lihat Forum</a>
