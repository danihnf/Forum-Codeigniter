        ...
        <input type="hidden" name="idthread" id="idthread" value="<?php echo $id ?>">
			 	<table class="tablereqComment">
               		 <tr>
                            ...
                            <td><label class="judul"><?php if(!empty($namaforum)) {echo $namaforum;} ?></label></td>
                        </tr>
             			<tr>
                        	<td style="width:100px;">Nama Thread</td>
                            <td style="width:10px;">:</td>
                            <td><input type="text" style="width:300px" name="tn" id="tn"></td>
                        </tr>
                        <tr>
                        	<td style="width:100px;">Isi Thread</td>
                            <td style="width:10px;">:</td>
